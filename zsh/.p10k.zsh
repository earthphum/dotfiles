# Generated by Powerlevel10k configuration wizard on 2025-07-10 at 16:28 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    #
    # virtualenv            # ชื่อ .venv
    # python                # version ของ python ใน .venv
    node_version          # version ของ node ในโฟลเดอร์นี้
    #
    time                    # current time
    # =========================[ Line #2 ]=========================
    newline                 # \n
    ...
    # เปิดใช้งาน virtualenv, python, node_version
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%BRETSAM%b'
